...
public class JavaMaster {
	...
	private static Questions[] GetQuestions() {
		...
		returnArray[1] = new Questions("What is JDK?", options.options2, 1,
				Tips.tip2);
		returnArray[2] = new Questions(
				"Which one isn't access modifier in Java?", options.options3,
				4, Tips.tip3);
		returnArray[3] = new Questions("When arrays are used?",
				options.options4, 4, Tips.tip4);
		returnArray[4] = new Questions(
				"What you will see on console when enter: System.out.println(null)?",
				options.options5, 4, Tips.tip5);
		returnArray[5] = new Questions(
				"Why Java program needs Java main method?", options.options6,
				1, Tips.tip6);
		returnArray[6] = new Questions("Why we use package in Java?",
				options.options7, 4, Tips.tip7);
		...
		returnArray[8] = new Questions(
				"Which fact about the Constructor is wrong?", options.options9,
				2, Tips.tip9);
		returnArray[9] = new Questions("Why isn't Java 100% Object-oriented?",
				options.options10, 3, Tips.tip10);
